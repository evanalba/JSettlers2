    ...
    extends SOCDisplaylessPlayerClient
{
    ...
    // TODO jdocs; see getServerGameOptions; since 2.7.00
    ...
    /**
     * Get options for a server game (TODO DOCS) announced to this client.
     * To get a game we've joined, call {@link SOCDisplaylessPlayerClient#getGame(String)} instead.
     * @param gaName  game name to look for
     * @return Game if we've seen it, or {@code null} if not found
     * @see #isServerGame(String)
     * @since 2.7.00
     */
